...
/**
 * Created by ko10ok on 13.08.2014.
 */
...
public class LCPMessage {
    ...
    public static byte[] getReadMessage(int mailbox, boolean delete){
        byte[] message = new byte[5];

        message[0] = DIRECT_COMMAND_REPLY;
        message[1] = MESSAGE_READ;
        message[2] = (byte) (mailbox + 0x09);
        message[3] = (byte) (mailbox*0); //TODO clear multiplier
        message[4] = (byte) ( delete ? 0xFF : 0x00 );
